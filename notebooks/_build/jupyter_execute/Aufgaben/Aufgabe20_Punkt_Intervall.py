...
# Die Breite des Konfidenzintervalls ist gegeben durch:
# 
# $$CI: \text{Punktschätzung} \pm \text{kritischer Punkt} \times\frac{s}{\sqrt{n}}$$
# 
# Der Stichprobenumfang geht also als Faktor $\frac{1}{\sqrt{n}}$ in die Gleichung ein. Um die Breite zu halbieren (bei ungefähr gleicher Stichprobenstandardabweichung) muß $n$ also vervierfacht werden. $\frac{1}{\sqrt{4n}} = \frac{1}{2\sqrt{n}}$
